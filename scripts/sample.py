...
def main():
    ...
    p.add_argument("stage", choices=["toy2d", "img2img-v1-val", "img2img-v1-infer"])
    ...
    stage_file = {
        ...
        "img2img-v1-infer": Path(__file__).resolve().parents[1] / "experiments" / "010_img2img_photo2comics" / "infer.py",
    }[args.stage]
